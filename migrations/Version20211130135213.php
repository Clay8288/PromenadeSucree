...
final class Version20211130135213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pastries (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(100) NOT NULL, quantity SMALLINT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, price SMALLINT DEFAULT NULL, INDEX IDX_32E1171412469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
